...
//        var conn: Connection? = null
    ...
    fun findContent(nc: NoteContentEntity, orders: String="UPDATE_TIME DESC, CREATE_TIME DESC"): ResultSet? {
        ...
        val sql = "SELECT " + getNoteContentEntityFullCol() + " FROM $dbName WHERE $condition AND DEL_FLAG = 0 ORDER BY $orders"
